...
def getDeck():
    ...
    random.shuffle(ls)
    try:
        con = sqlite3.connect('/home/jason/Projects/HW4/cards.db')
        cur = con.cursor()
        cur.executescript("""
...
def main():
    ...
    try:
        ...
        print ("<h1 style='color:green'>Welcome to Blackjack!</h1>")
        ...
        if (playerHandValue == 21):
            ...
            print("<button onclick='document.getElementById(\"lval\").value=" +
                                        str(lastPlayerCard+1) + "; this.form.submit();'>Yes</button>")
        ...
        if(lastPlayerCard < currentCard and not gameOver):
            ...
            if(dealerHandValue <= 21):
                ...
                print("<h2>Dealer Buster!!! Player Wins!!!</h2>")
                gameOver = True
